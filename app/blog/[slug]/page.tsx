    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full bg-gray-900">
        {post.heroVideo ? (
          ...
          <div className="relative w-full aspect-video max-h-[600px] bg-gray-200">
            {post.heroImage && (
              <Image
                src={post.heroImage}
                alt={post.title}
      ...
      <article className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-8">
            <span className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-600 text-white text-sm font-bold shadow-lg">
              {post.category}
            </span>
            <span className="inline-flex items-center px-4 py-2 rounded-full border-2 border-indigo-200 text-indigo-600 text-sm font-semibold bg-indigo-50">
              {post.branch}
            </span>
          </div>

          {/* Premium Title with Better Typography */}
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-indigo-900 mb-8 leading-tight text-left">
            {post.title}
          </h1>

          {/* Meta Info with Premium Styling */}
          <div className="flex flex-wrap items-center gap-6 text-indigo-600 pb-8 mb-12 border-b-2 border-indigo-200 text-left">
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-indigo-600">By <span className="text-indigo-900">{post.author}</span></span>
            </div>
          </div>
          ...
          <div className="prose prose-lg prose-gray max-w-none text-left">
            ...
            <p className="text-3xl text-indigo-700 leading-relaxed mb-12 font-light border-l-4 border-indigo-600 pl-6 italic text-left">
              {post.excerpt}
            </p>

            {/* Main Content - Detailed Information based on Branch */}
            <div className="space-y-10 text-lg text-indigo-900 leading-relaxed">
              <ContentSection post={post} />
            </div>

            {/* Premium Key Takeaways Box */}
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-l-4 border-indigo-600 rounded-r-xl p-8 my-12 shadow-lg text-left">
              <h3 className="text-3xl font-bold text-indigo-900 mb-5 flex items-center gap-2 text-left">
                <span className="w-2 h-2 bg-indigo-600 rounded-full"></span>
                Key Takeaways
              </h3>
              <ul className="space-y-3 text-lg text-indigo-800 text-left">
            ...
            <div className="relative overflow-hidden rounded-3xl my-16 shadow-2xl">
              ...
              <div className="relative z-10 p-12 md:p-16 text-left">
                <div className="max-w-7xl mx-auto">
                  ...
                  <p className="text-2xl text-indigo-100 mb-10 leading-relaxed text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link
                      href="/contact"
                      className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-indigo-600 rounded-xl font-bold hover:bg-indigo-50 transition-all duration-300 hover:scale-105 shadow-xl"
                    >
                    ...
                    <Link
                      href="/services"
                      className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-indigo-500 text-white rounded-xl font-bold hover:bg-indigo-400 transition-all duration-300 hover:scale-105 shadow-xl"
                    >
      ...
      {relatedPosts.length > 0 && (
        <section className="py-20 bg-white border-t-2 border-indigo-200">
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex items-center gap-3 mb-12">
              <div className="p-3 bg-indigo-600 rounded-xl">
                <BookOpen className="h-6 w-6 text-white" />
              </div>
              <h2 className="text-3xl font-bold text-indigo-900">Related Articles</h2>
            </div>
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    {relatedPost.heroImage ? (
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-indigo-200 via-indigo-300 to-indigo-400">
                        <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/20 via-indigo-700/20 to-indigo-800/20 group-hover:scale-110 transition-transform duration-700"></div>
                      </div>
                    )}
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-indigo-700 text-sm line-clamp-2 mb-4">
                      {relatedPost.excerpt}
                    </p>
