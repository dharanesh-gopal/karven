    ...
    <footer className="border-t border-gray-800 bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid gap-12 md:grid-cols-3 lg:grid-cols-5">
          {/* Products & Services */}
          <div>
            <h3 className="font-semibold mb-4 text-white text-base">Products & Services</h3>
          ...
          {/* Solutions */}
          <div>
            <h3 className="font-semibold mb-4 text-white text-base">Solutions</h3>
            <ul className="space-y-2.5">
          ...
          {/* Learn & Resources */}
          <div>
            <h3 className="font-semibold mb-4 text-white text-base">Learn & Resources</h3>
            <ul className="space-y-2.5">
          ...
          {/* Contact Sales */}
          <div>
            <h3 className="font-semibold mb-4 text-white text-base">Contact Sales</h3>
            <div className="space-y-4">
              <div>
                <p className="text-sm font-medium text-white mb-2">Phone</p>
                <a href="tel:+911234567890" className="text-sm text-gray-400 hover:text-white hover:underline block">
                  +91 123 456 7890
                </a>
                <a href="tel:+919876543210" className="text-sm text-gray-400 hover:text-white hover:underline block mt-1">
                  +91 987 654 3210
                </a>
              </div>
              <div>
                <p className="text-sm font-medium text-white mb-2">Email</p>
                <a href="mailto:sales@karvensen.com" className="text-sm text-gray-400 hover:text-white hover:underline block">
                  sales@karvensen.com
                </a>
                <a href="mailto:info@karvensen.com" className="text-sm text-gray-400 hover:text-white hover:underline block mt-1">
                  info@karvensen.com
                </a>
              </div>
              <div className="pt-2">
                <Link href="/support" className="text-sm text-blue-400 hover:underline flex items-center gap-1">
                  Technical Support →
                </Link>
                <Link href="/contact" className="text-sm text-blue-400 hover:underline flex items-center gap-1 mt-2">
                  Request a Demo →
                </Link>
              </div>
            </div>
        ...
        <div className="flex items-center justify-center gap-4 mt-12 pt-8 border-t border-gray-800">
          ...
          <a href="#" className="text-gray-400 hover:text-[#CD201F] transition-colors" aria-label="YouTube">
            <Youtube className="h-5 w-5" />
          </a>
          <a href="#" className="text-gray-400 hover:text-[#316FF6] transition-colors" aria-label="Facebook">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 text-xs text-gray-400">
            <span className="font-medium text-white">Group Companies:</span>
            <Link href="https://droneentry.com" className="hover:text-white transition-colors">
              Drone Entry
            </Link>
            <Link href="https://pyitechnologies.com" className="hover:text-white transition-colors">
              PYI Technologies
            </Link>
