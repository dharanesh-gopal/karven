...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    const pointers: any[] = []
    pointers.push(
      new (function pointerPrototype(this: any) {
        this.id = -1
        this.texcoordX = 0
        this.texcoordY = 0
    ...
    canvas.addEventListener(
      ...
      (e) => {
        ...
        for (let i = 0; i < touches.length; i++) {
          const pointer = pointers[i] || pointers[pointers.length - 1]
          const rect = canvas.getBoundingClientRect()
    ...
    materialsRef.current = { displayMaterial }
    framebuffersRef.current = { dye, velocity, divergence, curl, pressure }
  }, [
    SIM_RESOLUTION,
    DYE_RESOLUTION,
    CAPTURE_RESOLUTION,
