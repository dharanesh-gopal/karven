        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="flex items-center gap-2">
            <div className="relative">
              <div className="relative h-8 w-8 bg-gray-700 rounded-lg flex items-center justify-center">
            ...
            <SheetContent side="right" className="w-[280px] sm:w-[350px] bg-white p-6">
              <nav className="flex flex-col gap-6 mt-12">
                <Link
                  ...
                  className="text-lg font-medium text-gray-900 hover:text-gray-700 transition-colors px-2 py-1"
                >
                  Home
                </Link>
                <Link
